...
<div class="payslip-wrapper">
    ...
    <table>
        ...
        <tr><td>HRA</td><td><%= String.format("%.2f", payslip.getHra()) %></td></tr>
        <tr><td>DA</td><td><%= String.format("%.2f", payslip.getDa()) %></td></tr>
        ...
        <tr><td>Leaves Taken</td><td><%= payslip.getLeavesTaken() %></td></tr>
    ...
    <div class="btn-group">
        <button class="btn" onclick="window.print()">🖨️Print Payslip</button>
        <form action="DownloadPayslipServlet" method="post" style="display:inline;">
            <input type="hidden" name="employeeId" value="<%= payslip.getEmployeeId() %>">
            <input type="hidden" name="month" value="<%= payslip.getPaymentDate().getMonthValue() %>">
            <input type="hidden" name="year" value="<%= payslip.getPaymentDate().getYear() %>">
